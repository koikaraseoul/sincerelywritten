...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground px-4">
      <div className="text-center space-y-6 sm:space-y-8 animate-fadeIn w-full max-w-md">
        ...
        <button
          ...
          className="group relative w-24 h-24 sm:w-32 sm:h-32 mx-auto transition-all duration-300 hover:scale-110 focus:outline-none"
